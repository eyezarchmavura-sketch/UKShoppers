...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F6] font-sans">
      {/* Top Admin Header */}
      <header className="bg-[#0A3622] text-white sticky top-0 z-50 shadow-md">
        <div className="container flex items-center justify-between h-20 px-4 lg:px-8">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#F6E05E] text-[#0A3622] flex items-center justify-center font-bold text-lg">
              EA
            </div>
            <div>
              <h1 className="font-bold text-lg leading-none">
                UK Shoppers <span className="text-[#F6E05E]">Africa</span> — Operations Hub
              </h1>
              <p className="text-xs text-white/70 mt-1">Internal Team Dashboard (Isaac Mavura & Staff)</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/" className="text-xs font-semibold text-[#F6E05E] hover:underline">
              View Public Website
            </Link>
      ...
      <main className="container py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-border">
            <div className="flex items-center justify-between text-muted-foreground text-sm font-medium">
              ...
              <Package className="w-5 h-5 text-[#0A3622]" />
            </div>
            <div className="text-3xl font-bold text-[#0A3622] mt-2">24</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-border">
            ...
            <div className="text-3xl font-bold text-[#0A3622] mt-2">12 Parcels</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-border">
            ...
            <div className="text-3xl font-bold text-[#0A3622] mt-2">4 Countries</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-border">
            ...
            <div className="text-3xl font-bold text-[#0A3622] mt-2">£18,450</div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-border p-6 lg:p-8 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-bold text-[#0A3622]">Customer Purchase Requests & Shipments</h2>
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 rounded-xl border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#0A3622]"
                />
              </div>
              <Button
            ...
            {["All", "Pending Purchase", "London Warehouse", "Air Shipped to E.A.", "Delivered"].map((f) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                  filter === f
                    ? "bg-[#0A3622] text-[#F6E05E] shadow-sm"
                    : "bg-[#F4F7F6] text-foreground/75 hover:bg-muted"
                }`}>
                {f}
              </button>
            ))}
              ...
              <tbody className="divide-y divide-border text-sm">
                {filteredOrders.map((o) => (
                  <tr key={o.id} className="hover:bg-muted/40 transition-colors">
                    <td className="py-4 px-4 font-mono font-bold text-[#0A3622]">{o.id}</td>
                    ...
                    <td className="py-4 px-4 font-bold text-[#0A3622]">£{o.amountGBP.toFixed(2)}</td>
                    <td className="py-4 px-4">
                      <span
                    ...
                    <td className="py-4 px-4 text-right">
                      <select
                        ...
                        className="rounded-xl border border-input bg-background px-3 py-1.5 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#0A3622]">
